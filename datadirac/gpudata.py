...
"""
This is taken from gpudirac.device.data
"""
...
class GeneMap:
    ...
    def createBuffer(self, pairs_block_size, buff_dtype=np.int32):
        ...
        self.buffer_data = np.zeros((self.buffer_npairs*2,),
                                            dtype = buff_dtype)
...
class SampleMap:
    ...
    def createBuffer(self, samples_block_size, buff_dtype=np.int32):
        ...
        self.buffer_data = np.zeros((self.buffer_nsamples,
                                    self.buffer_kneighbors), dtype=buff_dtype)
